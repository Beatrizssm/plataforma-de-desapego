...
export function HistoryPage({ currentPage, onNavigate }: HistoryPageProps) {
  const transactions = [
    {
      id: "1",
    ...
    },
    {
      ...
      operation: "Venda Simbólica",
      date: "15/09/2025",
      status: "completed",
    },
    {
      id: "6",
      item: "Bicicleta Infantil",
      operation: "Doação",
      date: "10/09/2025",
      status: "completed",
    },
    ...
    <div className="flex min-h-screen bg-[#F8F3E7]">
      ...
      <main className="flex-1 md:ml-0 p-6 md:p-8">
        ...
        <div className="bg-white rounded-2xl border-2 border-[#C9A77A] shadow-lg overflow-hidden">
          <Table>
            <TableHeader>
              <TableRow className="bg-[#EADDC7] hover:bg-[#EADDC7]">
            ...
            <TableBody>
              {transactions.map((transaction, index) => (
                ...
                >
                  <TableCell className="text-[#3A2B1D]">
                    {transaction.item}
                  </TableCell>
                  <TableCell className="text-[#8B5E3C]">
